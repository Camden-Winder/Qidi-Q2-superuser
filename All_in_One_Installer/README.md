...
### **Warning** This tool is currently in a testing state. It is not recommended to install for begginer users. Join the Discord to check if it is stable and wait for announcements.
