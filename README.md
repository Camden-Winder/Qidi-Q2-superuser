...
1. Make a folder to put all of the docker .yml in. Spoolman, Octoeverywhere, and Octoapp all need one so it is best to be organized.
...
services:
  octoeverywhere-klipper-companion:
    ...
    volumes:
      ...
      - ./data:/data
```
Create a folder called `docker-compose.yml`
